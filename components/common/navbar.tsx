  ...
  return (
    <nav className="relative flex h-[55px] items-center border-b-[1px] border-gray-200 pl-2 text-gray-100 md:pl-8">
      ...
      <div className="hidden h-full items-center md:flex">
        <OneNavItem text="_hola" isActive={activeLink === "_hello"} />
      ...
      {activeLink !== "_hello" && (
        ...
        >
          <Image
            src={
              "https://res.cloudinary.com/dekgw9knc/image/upload/v1664538490/samples/Modern_Script_Elegant_Brand_Name_Typography_Logo_jynnp6.jpg"
            }
            height="100"
            width="100"
            layout="responsive"
